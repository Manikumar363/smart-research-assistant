/**
 * Test script for Live Source Ingestion Module
 * Demonstrates how to set up and use live sources
 */

const { liveIngester } = require('./routes/live-sources');
...
async function testLiveSourceIngestion() {
  ...
  // 4. Test HTML content fetching (optional - if needed)
...
module.exports = { testLiveSourceIngestion };